...
export default async function Home() {
  ...
  const cryptoSummary = configuredCryptoAddresses.length
    ? `${configuredCryptoAddresses.length} configured from local .env`
    : 'No local .env addresses configured';
  ...
  const sourceNoun = connectedSources === 1 ? 'source' : 'sources';
  ...
  return <>
    <main className="app-shell">
      ...
      <section id="holdings" className="holdings-section">
        <div className="section-heading"><div><h2>Holdings</h2><p>{holdingsCount} assets across {connectedSources || 1} {sourceNoun}</p></div><div className="button-row"><a href="#integrations" className="secondary-button">+ Add asset</a><a href="#integrations" className="secondary-button">Connect integration</a></div></div>
